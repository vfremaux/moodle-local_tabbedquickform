...
$string['exportprofiles'] = 'Import/export de profils de masques';
$string['exportprofiles_desc'] = 'Vous pouvez <a href="{$a->exporturl}">exporter</a> et <a href="{$a->importurl}">importer</a> des définitions de masque comme des simples listes de clefs. Vous pouvez également  <a href="{$a->reseturl}">réinitialiser tout ou partie</a> des masques actuellement enregistrés dans le site.';
