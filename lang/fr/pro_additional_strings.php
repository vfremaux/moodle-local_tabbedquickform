...
require_once($CFG->dirroot.'/local/tabbedquickform/lib.php'); // to get xx_supports_feature();
if ('pro' == local_tabbedquickform_supports_feature()) {
    include($CFG->dirroot.'/local/tabbedquickform/pro/lang/fr/pro.php');
}
